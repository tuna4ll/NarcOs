...
void update_status_bar()
{
    ...
    draw_char_direct(67, 1, 0xFE, 0x0C); 
...
void update_snake()
{
    ...
    draw_char_direct(apple_x, apple_y, 0xFE, 0x0C); 
    for (int i = snake_len - 1; i >= 1; i--) {
        uint8_t col = (i % 2 == 0) ? 0x02 : 0x0A; 
    ...
    draw_char_direct(snake_x[0], snake_y[0], head_char, 0x0E); 
}
